...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="5">
		<tr>
		  <td colspan=2><b>Available in 44 languages and dialects:</b> Arabian, Argentinian Spanish, Armenian, Brasilian Portuguese, Bulgarian, Catalan, Chinese (Simplified and Traditional), Czech, Danish, Deutch, Dutch, English (US & GB), Farsi (Persian), Finnish, French, Greek, Hebrew, Hindi (Devanagari), Hungarian, Indonesian (Bahasa Indonesia), Italian, Japanese, Korean, Lithuanian, Macedonian, Malaysian (Bahasa Melayu), Norwegian (Bokmål & Nynorsk), Polish, Portuguese, Romanian, Russian, Serbian (Latin), Slovak, Spanish, Swedish, Thai, Turkish, Ukrainean, Uzbek, Vietnamese, Yoruba (and counting...)<br />
...
<!-- START OF: Needed for the manual Language selector - not needed if you pass the LANG from your own script -->
		...
		echo ("<select name=\"hl\" onChange=\"this.form.submit()\">");
			...
			foreach ($langsfile as $langname)
			{
				...
				elseif ($langname == "uz_UZ") $LANG_NAME = "o`zbekcha";
...
#		$date5_default = date("Y-m-d",time() - $GapDays);
	...
	$date5_default = date("Y-m-d",time() - $GapDays);
	//----------------------------------------
	<br />	$myCalendar = new tc_calendar(&quot;date4&quot;, <b>true, false</b>);<br />	$myCalendar-&gt;setIcon(&quot;calendar/images/iconCalendar.gif&quot;);<br />	$myCalendar-&gt;setDate(date(&quot;d&quot;, strtotime($date4_default)), date(&quot;m&quot;, strtotime($date4_default)), date(&quot;Y&quot;, strtotime($date4_default)));<br />	$myCalendar-&gt;setPath(&quot;calendar/&quot;);<br />	$myCalendar-&gt;setYearInterval(1970, 2020);<br />	$myCalendar->setAlignment(&quot;left&quot;, &quot;bottom&quot;);<br />	$myCalendar->setDatePair(&quot;date4&quot;, &quot;date5&quot;, <b>$date5_default</b>);<br />	$myCalendar-&gt;writeScript();<br /><br />	$myCalendar = new tc_calendar(&quot;date5&quot;, <b>true, false</b>);<br />	$myCalendar-&gt;setIcon(&quot;calendar/images/iconCalendar.gif&quot;);<br />	$myCalendar-&gt;setDate(date(&quot;d&quot;, strtotime($date5_default)), date(&quot;m&quot;, strtotime($date5_default)), date(&quot;Y&quot;, strtotime($date5_default)));<br />	$myCalendar-&gt;setPath(&quot;calendar/&quot;);<br />	$myCalendar-&gt;setYearInterval(1970, 2020);<br />	$myCalendar->setAlignment(&quot;right&quot;, &quot;bottom&quot;);<br />	$myCalendar->setDatePair(&quot;date4&quot;, &quot;date5&quot;, <b>$date4_default</b>);<br />	$myCalendar-&gt;writeScript();<br />?&gt;<br /></pre>
...
<ul>
	<li>
		...
		<p><b>Sample Code:</b></p>
		<pre>&lt;?php<br />	$myCalendar = new tc_calendar(&quot;date_theme&quot;, true, false);<br />	$myCalendar-&gt;setIcon(&quot;calendar/images/iconCalendar.gif&quot;);<br />	$myCalendar-&gt;setDate(1, date('m'), date('Y'));<br />	$myCalendar-&gt;setPath(&quot;calendar/&quot;);<br />	$myCalendar-&gt;setYearInterval(2010, 2020);<br />	$myCalendar-&gt;setDateFormat('j F Y');<br />	$myCalendar-&gt;setAlignment('left', 'bottom');<br />	$myCalendar-&gt;setAutoHide(true, 10000); //10 secs<br />	$myCalendar-&gt;showWeeks(true);<br />	$myCalendar-&gt;startMonday(true);<br />	<strong>$myCalendar-&gt;setTheme('theme1');</strong><br />	$myCalendar-&gt;writeScript();<br />?&gt;</pre>
		  </td>
		  </tr>
		</table>
	  </td>
	...
	<tr>
	<td>
		<p style="background-color: #FFFFCC; border: 1px solid #FF9900; padding: 10px;"><b>Example of submiting value:</b> <a href="test_calendar.php" target="_blank">click here </a></p>
	</td>
  </tr>
	<tr>
	<td>
